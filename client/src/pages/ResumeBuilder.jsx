...
import { ArrowLeftIcon, User, FileText, Briefcase, GraduationCap, FolderIcon, Sparkles, ChevronLeft, ChevronRight ,EyeIcon,EyeOff, Share2Icon,DownloadIcon} from 'lucide-react'
...
const Resumebuilder = () => {
  ...
  const handleShare = () => {
    ...
    } else { alert("Share this link: " + resumeUrl)} 
  }
      ...
      <div className='max-w-7xl mx-auto px-4 pb-8'>
        <div className='grid lg:grid-cols-12 gap-8'>
          ...
          <div className='flex items-center'>
                ...
                Next <ChevronRight className="size-4"/>  I
                </button>
                </div>
              </div>
