     ...
     <>
            <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-white via-green-200/60 to-white mt-40">
                ...
                <div className="flex items-center gap-4 mt-3">
                    <a href="https://www.linkedin.com/in/piyushatrish" target="_blank" rel="noreferrer">
                    ...
                    {/* Update the href below with your actual GitHub link */}
                    <a href="https://github.com/piyush-atrish" target="_blank" rel="noreferrer">
                    ...
                    <p className="mt-3 text-center">© 2026 ResumeBuilder</p>
                </div>
                <style>{`
