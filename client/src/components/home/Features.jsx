   ...
   const [isHover, setIsHover] = React.useState(false);
    ...
    return (
        <div id="features" className="flex flex-col items-center my-10 scroll-mt-12">
            ...
            <Title title="Build your Resume" description="Our streamlined process makes it easy to create a professional resume in minutes." />
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Privacy support</h3>
                                <p className="text-sm text-slate-600 max-w-xs">keep your resumes public for companies / private - without hesitations of data breach</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-slate-600 max-w-xs">edit or create resumes with multiple interesting features.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Download for Free!</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Share your resumes live link or download in pdf mode without paying a single penny.</p>
                            </div>
                        </div>
                    </div>
                </div>
